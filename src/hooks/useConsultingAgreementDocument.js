...
export const useConsultingAgreementDocument = (id) => {
    ...
    const [documentName, setDocumentName] = useState('Untitled Consulting Agreement');
                ...
                try {
                    ...
                    if (business) {
                        setFormData(prev => ({
                            ...
                            clientAddress: [business.address, business.city, business.state, business.country].filter(Boolean).join(', '),
                        }));
                    }
                } catch (error) {
    ...
    const saveDocument = async (navigate) => {
        ...
        try {
            ...
            if (id) {
                ...
                if (navigate) navigate(`/documents/consulting-agreement/${newDoc.data.id}`, { replace: true });
