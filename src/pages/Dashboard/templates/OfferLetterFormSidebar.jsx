...
import { PenTool, Edit3, Layers, User, Briefcase, Calendar, DollarSign, Palette } from 'lucide-react';
            ...
            <div className="p-6 border-b border-slate-100 bg-slate-50/50 sticky top-0 z-10 backdrop-blur-sm">
                ...
                <div>
                    <h2 className="text-lg font-bold text-slate-900">
                        {mode === 'fill' ? 'Offer Letter Details' : 'Structure Builder'}
                    </h2>
                    <p className="text-xs text-slate-500 mt-1">
                        {mode === 'fill' ? 'Enter candidate and job details' : 'Customize letter layout'}
                    </p>
                </div>
            </div>
